...
The `NetworkState` type maintains the current state of networks and behaviors during simulation. It tracks adjacency matrices (as compact integer [`StateNetwork`](@ref) matrices with cached degrees) and behavior vectors as they evolve through mini-steps.
