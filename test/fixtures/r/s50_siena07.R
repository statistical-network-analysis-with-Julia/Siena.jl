...
cat("# use score-function derivative estimators by default; the independently\n")
cat("# simulated derivatives and covariances both carry Monte Carlo error.\n")
...
cat("\n# D and Sigma diagonals are asserted against the five-fit Julia mean.\n")
cat("# Relative tolerances: rates 25%, objective effects 20%.\n")
